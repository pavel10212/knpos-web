...
const EditStockModal = ({ isOpen, onClose, onSubmit, editStock, setEditStock }) => {
      ...
      >
        ...
        >
          <div className="p-6 bg-gradient-to-r from-indigo-600 to-blue-600">
            ...
            <p className="text-indigo-100 mt-1">Update product details</p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditStock({ ...editStock, inventory_item_name: e.target.value })}
